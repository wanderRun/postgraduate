...
CREATE TABLE IF NOT EXISTS `student_information` (
  ...
  `political_score` varchar(20) NOT NULL DEFAULT '0',
  `foreign_score` varchar(20) NOT NULL DEFAULT '0',
  `business_one_score` varchar(20) NOT NULL DEFAULT '0',
  `business_two_score` varchar(20) NOT NULL DEFAULT '0',
  `total_score` varchar(20) NOT NULL DEFAULT '0',
