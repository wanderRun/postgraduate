    ...
    class DataManager
    {
        ...
        public static void SaveDataFromExcel(string path)
        {
            try
            {
                ...
                for (int i = 1; i <= academicMasterGroup.Count; ++i)
                {
                    sheet = book.Sheets[1 + i];
                    sheet.Visible = XlSheetVisibility.xlSheetVisible;
                    for (int j = 1; j <= academicMasterGroup[i - 1].Count; j++)
                    {
                        sheet.Cells[j, 1] = academicMasterGroup[i - 1][j - 1].apply_place;
                        sheet.Cells[j, 2] = academicMasterGroup[i - 1][j - 1].aplly_number;
                        sheet.Cells[j, 3] = academicMasterGroup[i - 1][j - 1].name;
                        sheet.Cells[j, 4] = academicMasterGroup[i - 1][j - 1].name_spell;
                        sheet.Cells[j, 5] = academicMasterGroup[i - 1][j - 1].number;
                        sheet.Cells[j, 6] = academicMasterGroup[i - 1][j - 1].card_type;
                        sheet.Cells[j, 7] = academicMasterGroup[i - 1][j - 1].card_number;
                        sheet.Cells[j, 8] = academicMasterGroup[i - 1][j - 1].birth;
                        sheet.Cells[j, 9] = academicMasterGroup[i - 1][j - 1].nation;
                        sheet.Cells[j, 10] = academicMasterGroup[i - 1][j - 1].gender;
                        sheet.Cells[j, 11] = academicMasterGroup[i - 1][j - 1].marriage;
                        sheet.Cells[j, 12] = academicMasterGroup[i - 1][j - 1].soldier;
                        sheet.Cells[j, 13] = academicMasterGroup[i - 1][j - 1].politics_status;
                        sheet.Cells[j, 14] = academicMasterGroup[i - 1][j - 1].native_place;
                        sheet.Cells[j, 15] = academicMasterGroup[i - 1][j - 1].birth_place;
                        sheet.Cells[j, 16] = academicMasterGroup[i - 1][j - 1].register_place;
                        sheet.Cells[j, 17] = academicMasterGroup[i - 1][j - 1].register_address;
                        sheet.Cells[j, 18] = academicMasterGroup[i - 1][j - 1].record_place;
                        sheet.Cells[j, 19] = academicMasterGroup[i - 1][j - 1].record_ministry;
                        sheet.Cells[j, 20] = academicMasterGroup[i - 1][j - 1].record_address;
                        sheet.Cells[j, 21] = academicMasterGroup[i - 1][j - 1].record_place_postcode;
                        sheet.Cells[j, 22] = academicMasterGroup[i - 1][j - 1].work_place;
                        sheet.Cells[j, 23] = academicMasterGroup[i - 1][j - 1].work_experience;
                        sheet.Cells[j, 24] = academicMasterGroup[i - 1][j - 1].reward_punishment;
                        sheet.Cells[j, 25] = academicMasterGroup[i - 1][j - 1].family;
                        sheet.Cells[j, 26] = academicMasterGroup[i - 1][j - 1].contact_address;
                        sheet.Cells[j, 27] = academicMasterGroup[i - 1][j - 1].contact_postcode;
                        sheet.Cells[j, 28] = academicMasterGroup[i - 1][j - 1].fixed_line_phone;
                        sheet.Cells[j, 29] = academicMasterGroup[i - 1][j - 1].mobile_phone;
                        sheet.Cells[j, 30] = academicMasterGroup[i - 1][j - 1].email;
                        sheet.Cells[j, 31] = academicMasterGroup[i - 1][j - 1].source;
                        sheet.Cells[j, 32] = academicMasterGroup[i - 1][j - 1].same_education;
                        sheet.Cells[j, 33] = academicMasterGroup[i - 1][j - 1].school_code;
                        sheet.Cells[j, 34] = academicMasterGroup[i - 1][j - 1].school_name;
                        sheet.Cells[j, 35] = academicMasterGroup[i - 1][j - 1].major_name;
                        sheet.Cells[j, 36] = academicMasterGroup[i - 1][j - 1].study_type;
                        sheet.Cells[j, 37] = academicMasterGroup[i - 1][j - 1].last_education;
                        sheet.Cells[j, 38] = academicMasterGroup[i - 1][j - 1].diploma_number;
                        sheet.Cells[j, 39] = academicMasterGroup[i - 1][j - 1].graduate_date;
                        sheet.Cells[j, 40] = academicMasterGroup[i - 1][j - 1].register_number;
                        sheet.Cells[j, 41] = academicMasterGroup[i - 1][j - 1].last_degree;
                        sheet.Cells[j, 42] = academicMasterGroup[i - 1][j - 1].graduate_number;
                        sheet.Cells[j, 43] = academicMasterGroup[i - 1][j - 1].adjust_major_code;
                        sheet.Cells[j, 44] = academicMasterGroup[i - 1][j - 1].adjust_major_name;
                        sheet.Cells[j, 45] = academicMasterGroup[i - 1][j - 1].apply_place_code;
                        sheet.Cells[j, 46] = academicMasterGroup[i - 1][j - 1].apply_faculty;
                        sheet.Cells[j, 47] = academicMasterGroup[i - 1][j - 1].apply_faculty_name;
                        sheet.Cells[j, 48] = academicMasterGroup[i - 1][j - 1].apply_major_code;
                        sheet.Cells[j, 49] = academicMasterGroup[i - 1][j - 1].apply_major_name;
                        sheet.Cells[j, 50] = academicMasterGroup[i - 1][j - 1].apply_work_direction;
                        sheet.Cells[j, 51] = academicMasterGroup[i - 1][j - 1].apply_work_direction_name;
                        sheet.Cells[j, 52] = academicMasterGroup[i - 1][j - 1].exam_type;
                        sheet.Cells[j, 53] = academicMasterGroup[i - 1][j - 1].special_plan;
                        sheet.Cells[j, 54] = academicMasterGroup[i - 1][j - 1].apply_type;
                        sheet.Cells[j, 55] = academicMasterGroup[i - 1][j - 1].orientation_train_place_code;
                        sheet.Cells[j, 56] = academicMasterGroup[i - 1][j - 1].orientation_train_place;
                        sheet.Cells[j, 57] = academicMasterGroup[i - 1][j - 1].standby_information;
                        sheet.Cells[j, 58] = academicMasterGroup[i - 1][j - 1].standby_information_one;
                        sheet.Cells[j, 59] = academicMasterGroup[i - 1][j - 1].standby_information_two;
                        sheet.Cells[j, 60] = academicMasterGroup[i - 1][j - 1].standby_information_three;
                        sheet.Cells[j, 61] = academicMasterGroup[i - 1][j - 1].political_code;
                        sheet.Cells[j, 62] = academicMasterGroup[i - 1][j - 1].political_name;
                        sheet.Cells[j, 63] = academicMasterGroup[i - 1][j - 1].foreign_code;
                        sheet.Cells[j, 64] = academicMasterGroup[i - 1][j - 1].foreign_name;
                        sheet.Cells[j, 65] = academicMasterGroup[i - 1][j - 1].business_one_code;
                        sheet.Cells[j, 66] = academicMasterGroup[i - 1][j - 1].business_one_name;
                        sheet.Cells[j, 67] = academicMasterGroup[i - 1][j - 1].business_two_code;
                        sheet.Cells[j, 68] = academicMasterGroup[i - 1][j - 1].business_two_name;
                        sheet.Cells[j, 69] = academicMasterGroup[i - 1][j - 1].political_score;
                        sheet.Cells[j, 70] = academicMasterGroup[i - 1][j - 1].foreign_score;
                        sheet.Cells[j, 71] = academicMasterGroup[i - 1][j - 1].business_one_score;
                        sheet.Cells[j, 72] = academicMasterGroup[i - 1][j - 1].business_two_score;
                        sheet.Cells[j, 73] = academicMasterGroup[i - 1][j - 1].total_score;
                        sheet.Cells[j, 74] = academicMasterGroup[i - 1][j - 1].volunteer_type;
                        sheet.Cells[j, 75] = academicMasterGroup[i - 1][j - 1].tutor;
                        sheet.Cells[j, 76] = academicMasterGroup[i - 1][j - 1].student_confirm_status;
                        sheet.Cells[j, 77] = academicMasterGroup[i - 1][j - 1].student_confirm_time;
                        sheet.Cells[j, 78] = academicMasterGroup[i - 1][j - 1].student_reexamine;
                    }
                }

                //for (int i = 1; i <= professionalMasterGroup.Count; ++i)
                //{
                //    sheet = book.Sheets[1 + academicMasterGroup.Count + i];
                //    for (int j = 1; j <= professionalMasterGroup[i - 1].Count; j++)
                //    {
                //        sheet.Cells[j, 1] = professionalMasterGroup[i - 1][j - 1].apply_place;
                //        sheet.Cells[j, 2] = professionalMasterGroup[i - 1][j - 1].aplly_number;
                //        sheet.Cells[j, 3] = professionalMasterGroup[i - 1][j - 1].name;
                //        sheet.Cells[j, 4] = professionalMasterGroup[i - 1][j - 1].name_spell;
                //        sheet.Cells[j, 5] = professionalMasterGroup[i - 1][j - 1].number;
                //        sheet.Cells[j, 6] = professionalMasterGroup[i - 1][j - 1].card_type;
                //        sheet.Cells[j, 7] = professionalMasterGroup[i - 1][j - 1].card_number;
                //        sheet.Cells[j, 8] = professionalMasterGroup[i - 1][j - 1].birth;
                //        sheet.Cells[j, 9] = professionalMasterGroup[i - 1][j - 1].nation;
                //        sheet.Cells[j, 10] = professionalMasterGroup[i - 1][j - 1].gender;
                //        sheet.Cells[j, 11] = professionalMasterGroup[i - 1][j - 1].marriage;
                //        sheet.Cells[j, 12] = professionalMasterGroup[i - 1][j - 1].soldier;
                //        sheet.Cells[j, 13] = professionalMasterGroup[i - 1][j - 1].politics_status;
                //        sheet.Cells[j, 14] = professionalMasterGroup[i - 1][j - 1].native_place;
                //        sheet.Cells[j, 15] = professionalMasterGroup[i - 1][j - 1].birth_place;
                //        sheet.Cells[j, 16] = professionalMasterGroup[i - 1][j - 1].register_place;
                //        sheet.Cells[j, 17] = professionalMasterGroup[i - 1][j - 1].register_address;
                //        sheet.Cells[j, 18] = professionalMasterGroup[i - 1][j - 1].record_place;
                //        sheet.Cells[j, 19] = professionalMasterGroup[i - 1][j - 1].record_ministry;
                //        sheet.Cells[j, 20] = professionalMasterGroup[i - 1][j - 1].record_address;
                //        sheet.Cells[j, 21] = professionalMasterGroup[i - 1][j - 1].record_place_postcode;
                //        sheet.Cells[j, 22] = professionalMasterGroup[i - 1][j - 1].work_place;
                //        sheet.Cells[j, 23] = professionalMasterGroup[i - 1][j - 1].work_experience;
                //        sheet.Cells[j, 24] = professionalMasterGroup[i - 1][j - 1].reward_punishment;
                //        sheet.Cells[j, 25] = professionalMasterGroup[i - 1][j - 1].family;
                //        sheet.Cells[j, 26] = professionalMasterGroup[i - 1][j - 1].contact_address;
                //        sheet.Cells[j, 27] = professionalMasterGroup[i - 1][j - 1].contact_postcode;
                //        sheet.Cells[j, 28] = professionalMasterGroup[i - 1][j - 1].fixed_line_phone;
                //        sheet.Cells[j, 29] = professionalMasterGroup[i - 1][j - 1].mobile_phone;
                //        sheet.Cells[j, 30] = professionalMasterGroup[i - 1][j - 1].email;
                //        sheet.Cells[j, 31] = professionalMasterGroup[i - 1][j - 1].source;
                //        sheet.Cells[j, 32] = professionalMasterGroup[i - 1][j - 1].same_education;
                //        sheet.Cells[j, 33] = professionalMasterGroup[i - 1][j - 1].school_code;
                //        sheet.Cells[j, 34] = professionalMasterGroup[i - 1][j - 1].school_name;
                //        sheet.Cells[j, 35] = professionalMasterGroup[i - 1][j - 1].major_name;
                //        sheet.Cells[j, 36] = professionalMasterGroup[i - 1][j - 1].study_type;
                //        sheet.Cells[j, 37] = professionalMasterGroup[i - 1][j - 1].last_education;
                //        sheet.Cells[j, 38] = professionalMasterGroup[i - 1][j - 1].diploma_number;
                //        sheet.Cells[j, 39] = professionalMasterGroup[i - 1][j - 1].graduate_date;
                //        sheet.Cells[j, 40] = professionalMasterGroup[i - 1][j - 1].register_number;
                //        sheet.Cells[j, 41] = professionalMasterGroup[i - 1][j - 1].last_degree;
                //        sheet.Cells[j, 42] = professionalMasterGroup[i - 1][j - 1].graduate_number;
                //        sheet.Cells[j, 43] = professionalMasterGroup[i - 1][j - 1].adjust_major_code;
                //        sheet.Cells[j, 44] = professionalMasterGroup[i - 1][j - 1].adjust_major_name;
                //        sheet.Cells[j, 45] = professionalMasterGroup[i - 1][j - 1].apply_place_code;
                //        sheet.Cells[j, 46] = professionalMasterGroup[i - 1][j - 1].apply_faculty;
                //        sheet.Cells[j, 47] = professionalMasterGroup[i - 1][j - 1].apply_faculty_name;
                //        sheet.Cells[j, 48] = professionalMasterGroup[i - 1][j - 1].apply_major_code;
                //        sheet.Cells[j, 49] = professionalMasterGroup[i - 1][j - 1].apply_major_name;
                //        sheet.Cells[j, 50] = professionalMasterGroup[i - 1][j - 1].apply_work_direction;
                //        sheet.Cells[j, 51] = professionalMasterGroup[i - 1][j - 1].apply_work_direction_name;
                //        sheet.Cells[j, 52] = professionalMasterGroup[i - 1][j - 1].exam_type;
                //        sheet.Cells[j, 53] = professionalMasterGroup[i - 1][j - 1].special_plan;
                //        sheet.Cells[j, 54] = professionalMasterGroup[i - 1][j - 1].apply_type;
                //        sheet.Cells[j, 55] = professionalMasterGroup[i - 1][j - 1].orientation_train_place_code;
                //        sheet.Cells[j, 56] = professionalMasterGroup[i - 1][j - 1].orientation_train_place;
                //        sheet.Cells[j, 57] = professionalMasterGroup[i - 1][j - 1].standby_information;
                //        sheet.Cells[j, 58] = professionalMasterGroup[i - 1][j - 1].standby_information_one;
                //        sheet.Cells[j, 59] = professionalMasterGroup[i - 1][j - 1].standby_information_two;
                //        sheet.Cells[j, 60] = professionalMasterGroup[i - 1][j - 1].standby_information_three;
                //        sheet.Cells[j, 61] = professionalMasterGroup[i - 1][j - 1].political_code;
                //        sheet.Cells[j, 62] = professionalMasterGroup[i - 1][j - 1].political_name;
                //        sheet.Cells[j, 63] = professionalMasterGroup[i - 1][j - 1].foreign_code;
                //        sheet.Cells[j, 64] = professionalMasterGroup[i - 1][j - 1].foreign_name;
                //        sheet.Cells[j, 65] = professionalMasterGroup[i - 1][j - 1].business_one_code;
                //        sheet.Cells[j, 66] = professionalMasterGroup[i - 1][j - 1].business_one_name;
                //        sheet.Cells[j, 67] = professionalMasterGroup[i - 1][j - 1].business_two_code;
                //        sheet.Cells[j, 68] = professionalMasterGroup[i - 1][j - 1].business_two_name;
                //        sheet.Cells[j, 69] = professionalMasterGroup[i - 1][j - 1].political_score;
                //        sheet.Cells[j, 70] = professionalMasterGroup[i - 1][j - 1].foreign_score;
                //        sheet.Cells[j, 71] = professionalMasterGroup[i - 1][j - 1].business_one_score;
                //        sheet.Cells[j, 72] = professionalMasterGroup[i - 1][j - 1].business_two_score;
                //        sheet.Cells[j, 73] = professionalMasterGroup[i - 1][j - 1].total_score;
                //        sheet.Cells[j, 74] = professionalMasterGroup[i - 1][j - 1].volunteer_type;
                //        sheet.Cells[j, 75] = professionalMasterGroup[i - 1][j - 1].tutor;
                //        sheet.Cells[j, 76] = professionalMasterGroup[i - 1][j - 1].student_confirm_status;
                //        sheet.Cells[j, 77] = professionalMasterGroup[i - 1][j - 1].student_confirm_time;
                //        sheet.Cells[j, 78] = professionalMasterGroup[i - 1][j - 1].student_reexamine;
                //    }
                //}
                book.SaveAs(path);
                book.Close();
        ...
        public static void LoadStudentFromSQL()
        {
            ...
            for (int i = 0; i < dataTable.Rows.Count; ++i)
            {
                ...
                studentInfo.political_score = System.Convert.ToUInt32(Crypto.Instance.Decrypt(System.Convert.FromBase64String(dataTable.Rows[i]["political_score"].ToString())));
                studentInfo.foreign_score = System.Convert.ToUInt32(Crypto.Instance.Decrypt(System.Convert.FromBase64String(dataTable.Rows[i]["foreign_score"].ToString())));
                studentInfo.business_one_score = System.Convert.ToUInt32(Crypto.Instance.Decrypt(System.Convert.FromBase64String(dataTable.Rows[i]["business_one_score"].ToString())));
                studentInfo.business_two_score = System.Convert.ToUInt32(Crypto.Instance.Decrypt(System.Convert.FromBase64String(dataTable.Rows[i]["business_two_score"].ToString())));
                studentInfo.total_score = System.Convert.ToUInt32(Crypto.Instance.Decrypt(System.Convert.FromBase64String(dataTable.Rows[i]["total_score"].ToString())));
        ...
        public static void SaveStudentToSQL()
        {
            ...
            foreach (message.StudentInfo student in students.student)
            {
                ...
                data.Add(kvp);
                kvp = new KeyValuePair<string, string>("political_score", System.Convert.ToBase64String(Crypto.Instance.Encrypt(student.political_score.ToString())));
                data.Add(kvp);
                kvp = new KeyValuePair<string, string>("foreign_score", System.Convert.ToBase64String(Crypto.Instance.Encrypt(student.foreign_score.ToString())));
                data.Add(kvp);
                kvp = new KeyValuePair<string, string>("business_one_score", System.Convert.ToBase64String(Crypto.Instance.Encrypt(student.business_one_score.ToString())));
                data.Add(kvp);
                kvp = new KeyValuePair<string, string>("business_two_score", System.Convert.ToBase64String(Crypto.Instance.Encrypt(student.business_two_score.ToString())));
                data.Add(kvp);
                kvp = new KeyValuePair<string, string>("total_score", System.Convert.ToBase64String(Crypto.Instance.Encrypt(student.total_score.ToString())));
                data.Add(kvp);
